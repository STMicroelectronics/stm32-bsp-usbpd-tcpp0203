/**
  ******************************************************************************
  * @file    usbpd-tcpp0203_usbpd_pwr.c
...
/* Includes ------------------------------------------------------------------*/
#include "usbpd-tcpp0203_usbpd_pwr.h"
#include "usbpd-tcpp0203_bus.h"
...
/** @defgroup USBPD-TCPP0203_USBPD_PWR_Exported_Variables Exported Variables
  * @{
  */
/**
  * @}
...
/** @defgroup USBPD-TCPP0203_USBPD_PWR_Private_Typedef Private Typedef
  * @{
  */
/**
...
/** @defgroup USBPD-TCPP0203_USBPD_PWR_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup USBPD-TCPP0203_USBPD_PWR_Private_Macros Private Macros
  * @{
  */
#ifdef _TRACE
...
/** @defgroup USBPD-TCPP0203_USBPD_PWR_Private_Functions Private Functions
  * @{
  */
...
/** @defgroup USBPD-TCPP0203_USBPD_PWR_Private_Variables Private Variables
  * @{
  */
...
/** @addtogroup USBPD-TCPP0203_USBPD_PWR_Exported_Functions
  * @{
  */
...
int32_t BSP_USBPD_PWR_VBUSGetVoltage(uint32_t PortNum, uint32_t *pVoltage)
{
  ...
  else
  {
    ...
    voltage = PWR_TCPP0203_ConvertADCDataToVoltage(adc_value, USBPD_TCPP0203_VSENSE_RA, USBPD_TCPP0203_VSENSE_RB);
...
int32_t BSP_USBPD_PWR_VBUSGetCurrent(uint32_t PortNum, int32_t *pCurrent)
{
  ...
  else
  {
    ...
    current = PWR_TCPP0203_ConvertADCDataToCurrent(adc_value, USBPD_TCPP0203_ISENSE_GA, USBPD_TCPP0203_ISENSE_RS);
...
/** @addtogroup USBPD-TCPP0203_USBPD_PWR_Private_Functions
  * @{
  */

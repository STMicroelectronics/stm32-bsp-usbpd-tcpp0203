/**
  ******************************************************************************
  * @file    usbpd-tcpp0203_bus.c
  * @author  MCD Application Team
  * @brief   USBPD-TCPP0203 BUS driver.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup USBPD-TCPP0203_BUS USBPD-TCPP0203 BUS
  * @brief      This file includes the BUS and Low-level driver of USBPD-TCPP0203.
  * @{
  */

/** @defgroup USBPD-TCPP0203_BUS_Private_Macros Private Macros
  * @{
  */
...
/** @defgroup USBPD-TCPP0203_BUS_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup USBPD-TCPP0203_BUS_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup USBPD-TCPP0203_BUS_Private_Variables Private Variables
  * @{
  */
...
/** USBPD-TCPP0203_BUS_Private_FunctionPrototypes Private Functions
  */
...
/** @addtogroup USBPD-TCPP0203_BUS_Exported_Functions
  * @{
  */
/**
  * @brief  MX I2C Initialization as generated by CubeMX.
  * @retval Status
  */
__weak void MX_I2C_TCPP03_HANDLE_INIT(void)
{
...
int32_t BSP_I2C_Init(void)
{
  ...
  {
    /* Init the I2C */
    MX_I2C_TCPP03_HANDLE_INIT();
    if (HAL_I2CEx_ConfigAnalogFilter(&TCPP0X_HANDLE_I2C, I2C_ANALOGFILTER_ENABLE) != HAL_OK)
    {
...
/** @defgroup USBPD-TCPP0203_BUS_Private_Functions Private Functions
  * @{
  */
